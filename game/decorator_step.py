...
def step(self):
    ...
    for i in range(len(self.team1)):
        if self.team1[i].hp > 0:
            ...
            self.move_id_collision_map(self.team1[i], old_yx, old_coords)  # changing collision map
            print('coords', self.team1[i].Y, self.team1[i].X)
...
def move_id_collision_map(self, obj, old_yx, old_coords):
